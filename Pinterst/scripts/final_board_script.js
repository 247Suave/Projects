...
document.querySelector('.save_pin').addEventListener ('click', () => {
    const users_data = {
        ...
        destiantion:document.querySelector('#pin_destination').value,
            ...
            <div class="modal_foot">
                <div class="destination">
                   <div class="pint_mock_icon_container">
                       <img src="./img/top right arrow.png" alt="destination" class="pint_mock_icon">
                   </div> 
                   <span>${pin_details.destiantion}</span>
                </div>

                <div class="pint_mock_icon_container">
                    <img src="./img/sned icon.png" alt="send" class="pint_mock_icon">
                </div> 

                <div class="pint_mock_icon_container">
                    <img src="./img/elippse.png" alt="edit" class="pint_mock_icon">
                </div> 
            </div>
        </div>
